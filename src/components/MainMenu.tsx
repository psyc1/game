        ...
        <animated.div style={containerSpring} className="w-full max-w-4xl">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 max-w-4xl mx-auto">
              <div className="bg-black/40 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-cyan-400/30">
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-400/30">
              ...
              <div className="bg-black/40 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-green-400/30">
          ...
          <div className="space-y-4 w-full max-w-md mx-auto">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={startGame}
              className="w-full flex items-center justify-center space-x-3 px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 rounded-xl text-lg font-bold text-white transition-all duration-300 shadow-lg border border-green-400/50"
            >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center space-x-3 px-6 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 rounded-xl text-lg font-bold text-white transition-all duration-300 shadow-lg border border-blue-400/50"
            >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center space-x-3 px-6 py-4 bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 rounded-xl text-lg font-bold text-white transition-all duration-300 shadow-lg border border-purple-400/50"
            >
          ...
          <motion.div
            ...
            className="mt-8 p-4 sm:p-6 bg-black/60 backdrop-blur-lg rounded-xl border border-cyan-500/30 max-w-md mx-auto"
          >
      ...
      {showInstructions && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <motion.div
            ...
            className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-gray-900/95 to-black/95 rounded-2xl border border-cyan-400/50 backdrop-blur-lg p-6"
          >
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <div className="w-16 h-8 bg-gray-700 rounded flex items-center justify-center text-sm font-bold">WASD</div>
                    <span>Movimiento de la nave</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-16 h-8 bg-gray-700 rounded flex items-center justify-center text-sm font-bold">SPACE</div>
                    <span>Disparar</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-16 h-8 bg-gray-700 rounded flex items-center justify-center text-sm font-bold">P/ESC</div>
                    <span>Pausa</span>
                  </div>
                </div>
              </div>
            ...
            <motion.button
              ...
              className="mt-6 w-full px-6 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 rounded-xl text-lg font-bold text-white transition-all duration-300"
            >
      ...
      {showSettings && (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            className="w-full max-w-lg bg-gradient-to-br from-gray-900/95 to-black/95 rounded-2xl border border-purple-500/50 backdrop-blur-lg p-6"
          >
            ...
            <motion.button
              ...
              className="mt-6 w-full px-6 py-4 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 rounded-xl text-lg font-bold text-white transition-all duration-300"
            >
