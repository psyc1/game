...
export const GameUI: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-40">
      {/* Boss Health Bar (Top) - Only show when boss is active */}
      {showBoss && bossHP > 0 && (
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-full max-w-md px-4 pointer-events-auto">
          <div className="bg-slate-900/90 backdrop-blur-xl rounded-xl p-4 border border-red-500/30 shadow-2xl">
            ...
            <div className="text-center mt-2">
              <span className="text-white font-bold">{bossHP}/{bossMaxHP}</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="absolute left-4 top-4 bottom-4 w-72 pointer-events-auto">
        <div className="h-full bg-slate-900/95 backdrop-blur-xl rounded-xl border border-cyan-400/30 shadow-2xl p-4 flex flex-col overflow-y-auto">
          ...
          <div className="mt-auto">
            ...
            <div className="space-y-2 text-xs text-gray-300">
              <div className="flex items-center justify-between">
                <span>Mover</span>
                <div className="px-2 py-1 bg-gray-700 rounded text-xs font-bold">WASD</div>
              </div>
              <div className="flex items-center justify-between">
                <span>Disparar</span>
                <div className="px-2 py-1 bg-gray-700 rounded text-xs font-bold">SPACE</div>
              </div>
              <div className="flex items-center justify-between">
                <span>Pausa</span>
                <div className="px-2 py-1 bg-gray-700 rounded text-xs font-bold">P/ESC</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="absolute right-4 top-4 bottom-4 w-72 pointer-events-auto">
        <div className="h-full bg-slate-900/95 backdrop-blur-xl rounded-xl border border-cyan-400/30 shadow-2xl p-4 flex flex-col overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              <button
                onClick={pauseGame}
                className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 rounded-xl transition-all duration-300 border border-purple-400/50 shadow-lg hover:shadow-purple-500/25"
              >
              ...
              <button 
                onClick={resetGame}
                className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 rounded-xl transition-all duration-300 border border-red-400/50 shadow-lg hover:shadow-red-500/25"
              >
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-3 p-2 bg-slate-800/30 rounded-lg">
